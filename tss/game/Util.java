...
*/
    ...
    static boolean savingDataFile(String _nomefile, String _linha)
    {
        //throw new UnsupportedOperationException("Non ancora implementato!!");
    ...
    static boolean createDataFile(String _nomefile){
        //throw new UnsupportedOperationException("Non ancora implementato!!");
    ...
    void getDataFile(String _nomefile)
    {
        //throw new UnsupportedOperationException("Non ancora implementato!!");
    ...
    static boolean existDataFile(String _nomefile)
    {
        //throw new UnsupportedOperationException("Non ancora implementato!!");
        ...
        try {
            ...
            if (exists) System.out.println(path);
            if (tmpDir.isDirectory()) System.out.println(path + "is a directory");
